...
def load_config(config_path='config.yaml'):
    ...
    try:
        ...
        print(f"Warning: '{config_path}' not found. Created a default config file. Using default values.")
...
def setup_logging(log_file_path, logger_name='app_logger'):
    ...
    try:
        ...
        print(f"Error setting up file logger for '{log_file_path}': {e}. Logging to console only for this handler.")
